...
But the most basic type of request, is when a client asks the
HTTP Server to serve (i.e. to send) some specific web page (which is an HTML file) to him.
When you type `google.com` in your web browser, you are essentially sending an HTTP Request to Google's
